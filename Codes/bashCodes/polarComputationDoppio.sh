...
aoaArray=(-4 -2 0 2 4 6 8 10 12 13 14 145 15)
vXArray=(9.49681 9.5142 9.52 9.5142 9.49681 9.46785 9.42735 9.37537 9.31197 9.2760 9.23722 9.2168 9.1956)
vYArray=(-0.66408 -0.33224 0.0 0.33224 0.66408 0.99511 1.32493 1.65313 1.97932 2.1415 2.30310 2.3836 2.4640)
...
for jj in $(seq 0 1 $iter) ; do 
	...
	mpirun -n 12 --allow-run-as-root SU2_CFD $templateName >"logAoa${currentAoa}.log"
